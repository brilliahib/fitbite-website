...
export default function FormCreateMealPlan({
  setOpen,
}: FormCreateMealPlanProps) {
  ...
  const { mutate: createMealPlanHandler, isPending } = useCreateMealPlan({
    onError: () => {
      toast.error("Gagal membuat rencana makan!");
    },
    onSuccess: () => {
      toast.success("Berhasil membuat rencana makan!");
